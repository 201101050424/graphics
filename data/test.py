...
input_file = open('report.Runs.04.14.663.txt', 'r')
content_list = []
for each_line in input_file:
    content_list.append(each_line.decode('gb2312'))
